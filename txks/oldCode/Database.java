...
public class Database extends messiah.database.Database {
     ...
     */
    public Database(String name, boolean readOnly) {
        databaseName = name;
     ...
     */
    @Override
    public void openDatabase(String name, boolean readOnly) {
        // Ignore name
        openDatabase(readOnly);
    }
    ...
    public void copyPartialDatabaseToDisk() {
        ...
        if (false) {
            ...
            diskDB = null;
            diskDB = new messiah.database.berkeleydb.Database(s);
            diskDB.openSplitTables();
            partialOpen = true;
        }
    }
    ...
    public void copyDatabaseToDisk() {
        if (partialOpen) {
            diskDB.openNonSplitTables();
        }
        System.out.println("Copying to disk");
