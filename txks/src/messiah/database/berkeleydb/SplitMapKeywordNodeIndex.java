...
public class SplitMapKeywordNodeIndex extends SplitMap<String, Map<PathId, List<NodeId>>> implements Map<String, Map<PathId, List<NodeId>>> {
     ...
     * @param classType
     */
    public SplitMapKeywordNodeIndex(int maxNumberOfElements, Database db, String name, Class keyClass, Class valueClass) {
