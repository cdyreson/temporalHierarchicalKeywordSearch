 ...
 * @author Curt
 */
public class VirtualSimpleCachingFeedGroup implements Iterator<CachedNodeTriple> {
    ...
    public VirtualSimpleCachingFeedGroup() {
    ...
    public void addFeed(short dimension, short count, Iterator<NodeId> feed, PathId pathId, String keyword) {
        ...
        if (verbose) {
            System.out.println("VirtualSimpleCachingFeedGroup addFeed " + keyword + " " + pathId + " " + dimension + " " + count);
        }
        ...
        if (!feed.hasNext()) {
            if (verbose) {
                System.out.println("VirtualSimpleCachingFeedGroup addFeed empty feed!");
            }
            return;
        }
    ...
    public boolean hasNext() {
        if (verbose) {
            System.out.println("VirtualSimpleCachingFeedGroup hasNext " + feeds.isEmpty());
        }
    ...
    public CachedNodeTriple next() {
        if (verbose) {
            System.out.println("VirtualSipmleCachingFeedGroup next: " + hasNext());
        }
        ...
        if (verbose) {
            System.out.println("VirtualSimpleCachingFeedGroup start: nodeId " + nodeId + " id " + tuple.id + " dimension " + tuple.dimension);
        }
