 ...
 */
public class HistoryJSONParseTask extends JSONParseTask {

    public HistoryJSONParseTask(Database db, File inputFile, IntervalGenerator i, int maxNodes) throws FileNotFoundException {
        super(db, inputFile, maxNodes);
        HistoryDLNFactory h = new HistoryDLNFactory();
        this.nodeIdBuilder = new TemporalNodeIdBuilder(h, i);
    }

    public HistoryJSONParseTask(Database db, NodeIdBuilder nodeBuilder, XMLStreamReader reader)  {
