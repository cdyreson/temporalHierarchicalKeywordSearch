...
public class TXKSParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ARROW", "AT", "COMMA", "DIGIT", "DOUBLEWILDCARD", "EOS", "EQUALS", "GE", "GT", "ID", "INT", "K_AFTER", "K_ANY", "K_BEFORE", "K_CONTAINS", "K_CURRENT", "K_DESCENDANTCHANGES", "K_DESCENDANTVERSIONS", "K_DURATION", "K_EARLIEST", "K_INTERSECTS", "K_LATEST", "K_MEETS", "K_NONSEQUENCED", "K_NONTEMPORAL", "K_SEQUENCED", "K_SLICE", "LBRACE", "LBRACKET", "LE", "LETTER", "LPAREN", "LT", "NAMECHAR", "NOT", "PIPE", "RBRACE", "RBRACKET", "RPAREN", "STRING", "WILDCARD", "WS"
    };
    ...
    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:185:1: statedSearchType returns [Integer i] : k= ( K_SEQUENCED | K_NONSEQUENCED | K_EARLIEST | K_DURATION | K_LATEST | K_NONTEMPORAL | K_CURRENT ) ;
    public final Integer statedSearchType() throws RecognitionException {
        ...
        try {
            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:185:37: (k= ( K_SEQUENCED | K_NONSEQUENCED | K_EARLIEST | K_DURATION | K_LATEST | K_NONTEMPORAL | K_CURRENT ) )
            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:186:5: k= ( K_SEQUENCED | K_NONSEQUENCED | K_EARLIEST | K_DURATION | K_LATEST | K_NONTEMPORAL | K_CURRENT )
            {
            k=(Token)input.LT(1);
    ...
    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:191:1: expression returns [KeywordSearchExpression exp] : ( ( LPAREN exp1= expression RPAREN ) | (s1= stringOrId ( (op= operator e2= expression ) | (s2= stringOrId exp1= stringExpression ) )? ) |);
    public final KeywordSearchExpression expression() throws RecognitionException {
        ...
        try {
            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:191:50: ( ( LPAREN exp1= expression RPAREN ) | (s1= stringOrId ( (op= operator e2= expression ) | (s2= stringOrId exp1= stringExpression ) )? ) |)
            int alt3=3;
            switch ( input.LA(1) ) {
            case LPAREN:
                {
            ...
            switch (alt3) {
                case 1 :
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:192:5: ( LPAREN exp1= expression RPAREN )
                    {
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:192:5: ( LPAREN exp1= expression RPAREN )
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:192:6: LPAREN exp1= expression RPAREN
                    {
                    ...
                    break;
                case 2 :
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:197:5: (s1= stringOrId ( (op= operator e2= expression ) | (s2= stringOrId exp1= stringExpression ) )? )
                    {
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:197:5: (s1= stringOrId ( (op= operator e2= expression ) | (s2= stringOrId exp1= stringExpression ) )? )
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:197:6: s1= stringOrId ( (op= operator e2= expression ) | (s2= stringOrId exp1= stringExpression ) )?
                    {
                    ...
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:202:5: ( (op= operator e2= expression ) | (s2= stringOrId exp1= stringExpression ) )?
                    int alt2=3;
                    int LA2_0 = input.LA(1);

                    if ( (LA2_0==K_AFTER||(LA2_0 >= K_BEFORE && LA2_0 <= K_CONTAINS)||LA2_0==K_INTERSECTS||LA2_0==K_MEETS) ) {
                        alt2=1;
                    }
                    ...
                    switch (alt2) {
                        case 1 :
                            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:202:6: (op= operator e2= expression )
                            {
                            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:202:6: (op= operator e2= expression )
                            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:202:7: op= operator e2= expression
                            {
                            ...
                            break;
                        case 2 :
                            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:206:9: (s2= stringOrId exp1= stringExpression )
                            {
                            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:206:9: (s2= stringOrId exp1= stringExpression )
                            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:206:10: s2= stringOrId exp1= stringExpression
                            {
                    ...
                    break;
                case 3 :
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:215:7: 
                    {
    ...
    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:220:5: stringExpression returns [KeywordSearchExpression exp] : ( (s2= stringOrId exp1= stringExpression ) |);
    public final KeywordSearchExpression stringExpression() throws RecognitionException {
        ...
        try {
            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:220:60: ( (s2= stringOrId exp1= stringExpression ) |)
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:221:5: (s2= stringOrId exp1= stringExpression )
                    {
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:221:5: (s2= stringOrId exp1= stringExpression )
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:221:6: s2= stringOrId exp1= stringExpression
                    {
                    ...
                    break;
                case 2 :
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:228:5: 
                    {
    ...
    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:263:1: operator returns [int code] : c= ( K_CONTAINS | K_INTERSECTS | K_BEFORE | K_AFTER | K_MEETS ) ;
    public final int operator() throws RecognitionException {
        ...
        try {
            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:263:28: (c= ( K_CONTAINS | K_INTERSECTS | K_BEFORE | K_AFTER | K_MEETS ) )
            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:264:5: c= ( K_CONTAINS | K_INTERSECTS | K_BEFORE | K_AFTER | K_MEETS )
            {
            c=(Token)input.LT(1);

            if ( input.LA(1)==K_AFTER||(input.LA(1) >= K_BEFORE && input.LA(1) <= K_CONTAINS)||input.LA(1)==K_INTERSECTS||input.LA(1)==K_MEETS ) {
                input.consume();
                state.errorRecovery=false;
            }
            else {
    ...
    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:267:1: stringOrId : (x= STRING |v= ID );
    public final TXKSParser.stringOrId_return stringOrId() throws RecognitionException {
        ...
        try {
            // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:267:34: (x= STRING |v= ID )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:268:5: x= STRING
                    {
                    x=(Token)match(input,STRING,FOLLOW_STRING_in_stringOrId482); 

                    }
                    break;
                case 2 :
                    // C:\\Users\\curt\\Dropbox\\netbeans\\keywordSearch\\txks\\src\\usu\\grammar\\TXKS.g:269:7: v= ID
                    {
                    v=(Token)match(input,ID,FOLLOW_ID_in_stringOrId495); 
    ...
    public static final BitSet FOLLOW_searchType_in_kindOfSearch124 = new BitSet(new long[]{0x0000080800002000L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_expression242 = new BitSet(new long[]{0x00000C0800002000L});
    public static final BitSet FOLLOW_expression_in_expression246 = new BitSet(new long[]{0x0000040000000000L});
    public static final BitSet FOLLOW_RPAREN_in_expression248 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_stringOrId_in_expression267 = new BitSet(new long[]{0x000008000506A002L});
    public static final BitSet FOLLOW_operator_in_expression284 = new BitSet(new long[]{0x0000080800002000L});
    public static final BitSet FOLLOW_expression_in_expression288 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_stringOrId_in_expression304 = new BitSet(new long[]{0x0000080000002000L});
    public static final BitSet FOLLOW_stringExpression_in_expression308 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_stringOrId_in_stringExpression378 = new BitSet(new long[]{0x0000080000002000L});
    ...
    public static final BitSet FOLLOW_STRING_in_stringOrId482 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ID_in_stringOrId495 = new BitSet(new long[]{0x0000000000000002L});
