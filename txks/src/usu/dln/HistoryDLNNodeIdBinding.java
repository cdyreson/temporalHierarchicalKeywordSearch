...
public class HistoryDLNNodeIdBinding extends NodeIdBinding {
    ...
    public void objectToEntry(NodeId s, TupleOutput out) {
        if (s instanceof TimeElementHistoryDLN) {
            s = ((TimeElementHistoryDLN)s).toHistoryDLN();
        }
        objectToEntry((HistoryDLN) s, out);
    }
    
    /*
    public void objectToEntry(TimeElementHistoryDLN s, TupleOutput out) {
        objectToEntry(s.toHistoryDLN(), out);
    }
    */
