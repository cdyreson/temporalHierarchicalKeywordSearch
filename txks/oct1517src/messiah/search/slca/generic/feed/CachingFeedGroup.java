 ...
 * @author Curt
 */
public class CachingFeedGroup implements Iterator<CachedNodeTriple> {
    ...
    public boolean hasNext() {
        if (verbose) {
            System.out.println("CachingFeedGroup hasNext " + feeds.isEmpty());
        }
    ...
    public CachedNodeTriple next() {
        if (verbose) {
            System.out.println("CachingFeedGroup next: " + hasNext());
        }
        ...
        if (verbose) {
            System.out.println("CachingFeedGroup start: nodeId " + nodeId);
        }
