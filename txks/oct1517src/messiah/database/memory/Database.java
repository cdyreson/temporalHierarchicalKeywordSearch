...
public class Database extends messiah.database.Database {
    ...
    public void openDatabase() {
        if (!alreadyOpen) {
            ...
            // Branch tables
            branchIndex = openTable("branchIndex", String.class, List.class);
            prefixIndex = openTable("prefixIndex", String.class, List.class);
    ...
    public void printSizes() {
        ...
        System.out.println("termNodeIndex size " + termNodeIndex.size());
        ...
        System.out.println("branchIndex size " + branchIndex.size());
        System.out.println("prefixIndex size " + prefixIndex.size());
    ...
    public void copyPartialDatabaseToDisk() {
        ...
        diskDB.branchIndex.putAll(branchIndex);
        diskDB.prefixIndex.putAll(prefixIndex);
    ...
    public void copyDatabaseToDisk() {
        ...
        diskDB.termIndex.putAll(termIndex);
