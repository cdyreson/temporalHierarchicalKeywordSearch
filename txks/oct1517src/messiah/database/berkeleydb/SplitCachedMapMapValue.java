 ...
 */
public class SplitCachedMapMapValue<K, V> extends SplitCachedMap<K, V> implements Map<K, V> {
     ...
     * @param classType
     */
    public SplitCachedMapMapValue(int maxNumberOfElements, boolean isReadOnly, Database db, String name, Class keyClass, Class valueClass) {
